      ...
      render: (text, record) => (
        ...
        >
          ...
          <div className="dropdown-menu dropdown-menu-right">
            <a
              onClick={() => {
                handleApproved(record.employee_leave_id);
              }}
            ...
            <a
              onClick={() => {
                handleDeclined(record.employee_leave_id);
              }}
              className="dropdown-item"
              href="#"
            >
