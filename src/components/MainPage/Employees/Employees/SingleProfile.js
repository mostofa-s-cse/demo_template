...
const SingleProfile = () => {
  ...
  const { user } = useAuth();
  const emp_id = user ? user.employe_id : "";
  ...
  const {
    register: registerAddLeave,
    reset: reset18,
    formState: { errors: errorsAddLeave },
    handleSubmit: handleSubmitAddLeave,
  } = useForm();
  const {
  ...
  const employeeImageUpdateHandle = (e) => {
    ...
    console.log(imageEmployee)
    const fileType = imageEmployee.type.split('/')
    const fileSize = imageEmployee.size;
  ...
  return (
    <div className="page-wrapper">
     ...
     fa fa-pencil me-2"
                          ...
                          <h3 className="card-title">
                            ...
                            <span className="col-auto float-right">
                              <a
                                className="add-icon"
                                data-toggle="modal"
                                data-target="#document_info_modal_post"
                              >
                                <i className="fa fa-plus" /> Add
                              </a>
                            </span>
                                  ...
                                  <tr>
                                    ...
                                    <td className="personal-text">
                                      {item.employee_doc && (
                                        <div className="d-flex text-center">
                                          <a
                                            target="_blank"
                                            className="input-group-text w-25 cursor-pointer btn-eye ms-2 fs-5"
                                            href={`http://${Api}/static${item.employee_doc}`}
                                          >
                                            <i className="fa fa-eye" />
                                          </a>
                                        </div>
                                    ...
                                    <td className="text-right">
                                      <div className="dropdown dropdown-action">
                                        ...
                                        className="dropdown-item"
                                        data-toggle="modal"
                                        data-target="#document_info_modal"
                                        onClick={() => {
                                          handleDocUpdate(item.employee_doc_id);
                                        }}
                                      >
                                        <i className="fa fa-pencil m-r-5" />{" "}
                                        Edit
            ...
            <div className="modal bg-dark custom-modal fade" id="showProfile" role="dialog">
              <div
              ...
              >
                <div className="modal-content bg-dark">
                  <div className="modal-header">
                    <h5 className="modal-title text-light">Profile Photo</h5>
                    <button
                      type="button"
                      className="close"
                      data-dismiss="modal"
                  ...
                  <div className="submit-section">
                    <button
                      type="button"
                      className="btn bgColor text-white px-5 ms-1 py-2 mb-3 rounded"
                      data-dismiss="modal"
                    >
                      Close
                    </button>
            ...
            >
              ...
              >
                <div className="modal-content">
                  <div className="modal-header">
                    <h5 className="modal-title smart-text">Profile Photo Update</h5>
                    <button
                      type="button"
                      className="close"
                      data-dismiss="modal"
                          ...
                          <div className="row">
                            <div className="col-sm-6">
                              {src && (
                                <div>
                                  <ReactCrop
                                    crop={crop} src={src} width="100" height="100" onChange={setCrop} onImageLoaded={setImage}>

                                  </ReactCrop>
                                  <br />
                                  <button className="btn bgColor text-white px-5 py-2 rounded" onClick={cropImageNow}>Crop</button>
                                  <br />
                                  <br />
                                </div>
                              )}
                  ...
                  <div className="submit-section">
                    <button className="btn bgColor text-center text-white px-5 mb-3 rounded" onClick={imageUploadHandle}>Upload</button>
     ...
     ms-2"
            ...
            {/* Documents Informations POST AND PUT  */}

            <div
              id="document_info_modal_post"
              className="modal custom-modal fade"
              role="dialog"
            >
              <div
              ...
              >
                <div className="modal-content">
                  ...
                  <div className="modal-body text-start">
                    <form onSubmit={handleSubmitDocPost(onSubmitDocumentPost)}>
                      <div className="row">
                        <div className="mb-3">
                          <label
                            htmlFor="exampleFormControlInput44"
                        ...
                        <div className="mb-3">
                          ...
                          <select
                            className="form-select"
                            id="inputGroupSelect46"
                            {...registerDocPost("document_type_id")}
                          >
                            {/* <option value={singleDocData.document_type_id}>
                          {singleDocData.document_type}
                        </option> */}
            ...
            {/*Add Leave Informations  */}

            <div id="addLeave" className="modal custom-modal fade" role="dialog">
              <div
                className="modal-dialog modal-dialog-centered modal-lg"
                role="document"
              >
                <div className="modal-content">
                  ...
                  <div className="modal-body text-start">
                    <form onSubmit={handleSubmitAddLeave(onSubmitAddLeave)}>
                      <div className="row">
                        <div className="col-sm-6">
                          <div className="mb-3">
                            <label
                        ...
                        <div className="col-sm-6">
                          ...
                          <div className="mb-3">
                            ...
                            <textarea
                              ...
                              {...registerAddLeave("employee_memo")}
                            ></textarea>
                          </div>
                          ...
                          <div className="mb-3">
                            ...
                            <textarea
                              ...
                              {...registerAddLeave("memo_validator")}
                            ></textarea>
                          </div>
                        </div>
                      </div>
