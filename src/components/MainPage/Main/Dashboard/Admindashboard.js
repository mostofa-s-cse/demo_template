...
const AdminDashboard = () => {
  ...
  const [totalCurrentEmployee, setTotalCurrentEmployee] = useState(0);
  const [totalCurrentEmployeeHealth, setTotalCurrentEmployeeHealth] = useState(0);
  const [totalMissingLpr, setTotalMissingLpr] = useState(0)
  const [totalEmpLoanArray, setTotalEmpLoanArray] = useState([]);
  const [totalEmpLeaveArray, setTotalEmpLeaveArray] = useState([]);
  const [totalEmpPromotionsArray, setTotalEmpPromotionsArray] = useState([]);
  const [totalEmpDisciplinesArray, setTotalEmpDisciplinesArray] = useState([]);
  ...
  useEffect(() => {
    const getUsers = () => {
      ...
      fetch(`/ords/hrm/employees/v_emp?limit=100000`)
        ...
        .then(users => {
          setTotalEmployee(users.items.length);
          setIsLoading(false);
        },
          err => {
            const mute = err
  ...
  useEffect(() => {
    const getUsers = () => {
      setIsLoading(true);
      fetch(`/ords/hrm/emp_dash_admin/current_emp`)
        .then(res => {
        ...
        .then(users => {
          setTotalCurrentEmployee(users.current_emp);
          setIsLoading(false);
        },
  ...
  // total current employee Health

  useEffect(() => {
    const getUsers = () => {
      setIsLoading(true);
      fetch(`/ords/hrm/emp_dash_admin/curr_employee_health`)
        .then(res => {
        ...
        .then(users => {
          setTotalCurrentEmployeeHealth(users.curr_employee_health);
          setIsLoading(false);
        },
  ...
  // total Missing LPR Date
  // total loan 
  useEffect(() => {
    const getUsers = () => {
      setIsLoading(true);
      fetch(`/ords/hrm/emp_dash_admin/missing_emp_lrp_date`)
        .then(res => {
        ...
        .then(users => {
          setTotalMissingLpr(users.missing_emp_lrp_date);
          setIsLoading(false);
        },
  ...
  useEffect(() => {
    const getUsers = () => {
      ...
      fetch(`/ords/hrm/emp_pro/crud`)
        ...
        .then(users => {
          setTotalEmpPromotionsArray(users.items)
          setIsLoading(false);
        },
  ...
  const remainingApprovedUsers = totalEmpLoanArray.filter(user => user.status === 'Approved');
  const remainingPendingUsers = totalEmpLoanArray.filter(user => user.status === 'New');
  const remainingCancelledUsers = totalEmpLoanArray.filter(user => user.status === 'Declined');
  const remainingLeaveApprovedUsers = totalEmpLeaveArray.filter(user => user.status === 'Approved');
  const remainingLeavePendingUsers = totalEmpLeaveArray.filter(user => user.status === 'New');
  const remainingLeaveCancelledUsers = totalEmpLeaveArray.filter(user => user.status === 'Declined');
  const remainingPromotionsApprovedUsers = totalEmpPromotionsArray.filter(user => user.type_promotion === 'Promotion');
  const remainingPromotionsCancelledUsers = totalEmpPromotionsArray.filter(user => user.type_promotion === 'Charge');
        ...
        <div className="content container-fluid">
          ...
          <div className="row">
            ...
            <div className="col-md-6 col-sm-6 col-lg-6 col-xl-3">
              <div className="card dash-widget">
                <div className="card-body">
                  <span className="dash-widget-icon"><i className="fa fa-user" /></span>
                  <div className="dash-widget-info">
                    <h3> {totalCurrentEmployee} </h3>
                    <span>Eligible For PRL</span>
                  </div>
                </div>
              </div>
            </div>
            <div className="col-md-6 col-sm-6 col-lg-6 col-xl-3">
              <div className="card dash-widget">
                <div className="card-body">
                  <span className="dash-widget-icon"><i className="fa fa-medkit"></i></span>
                  <div className="dash-widget-info">
                    <h3> {totalCurrentEmployeeHealth} </h3>
                    <span>Health</span>
                  </div>
                </div>
              </div>
            ...
            <div className="col-md-6 col-sm-6 col-lg-6 col-xl-3">
              <div className="card dash-widget">
                <div className="card-body">
                  ...
                  <div className="dash-widget-info">
                    <h3>{totalMissingLpr}</h3>
                    <span>Missing PRL</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="row">
            <div className="col-md-6 col-sm-6 col-lg-6 col-xl-6 ">
              <div className="card dash-widget bg-gradient-purple text-white">
                <div className="card-header bg-gradient-purple">
                  <span className="dash-widget-icon text-white"><i className="fa fa-usd" ></i></span>
                  <div className="dash-widget-info">
                ...
                <div className="card-body">
                  <div className="row">
                    <div className="col-sm-4 border-end border-2 border-primary">
                      <h3 className='text-white'>{remainingPendingUsers.length}</h3>
                      <span className='text-white'>PENDING</span>
                    </div>
                    <div className="col-sm-4 border-end border-2 border-primary">
                      <h3 className='text-white'>{remainingApprovedUsers.length}</h3>
                      <span className='text-white'>APPROVED</span>
                    </div>
                    <div className="col-sm-4">
                      <h3 className='text-white'>{remainingCancelledUsers.length}</h3>
            ...
            <div className="col-md-6 col-sm-6 col-lg-6 col-xl-6 ">
              <div className="card dash-widget bg-gradient-primary text-white">
                <div className="card-header bg-gradient-primary">
                  <span className="dash-widget-icon text-white"><i className="fa fa-minus-square" aria-hidden="true"></i></span>
                  <div className="dash-widget-info">
                ...
                <div className="card-body">
                  <div className="row">
                    <div className="col-sm-4 border-end border-2 border-primary">
                      <h3 className='text-white'>{remainingLeavePendingUsers.length}</h3>
                      <span className='text-white'>PENDING</span>
                    </div>
                    <div className="col-sm-4 border-end border-2 border-primary">
                      <h3 className='text-white'>{remainingLeaveApprovedUsers.length}</h3>
                      <span className='text-white'>APPROVED</span>
                    </div>
                    <div className="col-sm-4">
                      <h3 className='text-white'>{remainingLeaveCancelledUsers.length}</h3>
                      <span className='text-white'>CANCELLED</span>
                    </div>
                  </div>
                </div>
            ...
            <div className="col-md-6 col-sm-6 col-lg-6 col-xl-6">
              <div className="card dash-widget bg-project">
                <div className="card-header bg-project text-white">
                  <span className="dash-widget-icon text-white"><i className="fa fa-arrow-circle-o-up" aria-hidden="true"></i></span>
                  <div className="dash-widget-info">
                    <h3 className='text-white'>{totalEmpPromotionsArray.length}</h3>
                ...
                <div className="card-body ">
                  <div className="row">
                    <div className="col-sm-6 border-end border-2  border-primary">
                      <h3 className='text-white'>{remainingPromotionsApprovedUsers.length}</h3>
                      <span className=' text-white'>PROMOTIONS</span>
                    </div>
                    <div className="col-sm-6 border-2  border-primary">
                      <h3 className='text-white'>{remainingPromotionsCancelledUsers.length}</h3>
            ...
            <div className="col-md-6 col-sm-6 col-lg-6 col-xl-6">
              <div className="card dash-widget bg-project">
                <div className="card-header bg-project text-white">
                  <span className="dash-widget-icon text-white"><i className="fa fa-graduation-cap" aria-hidden="true"></i></span>
                  <div className="dash-widget-info">
            ...
            <div className="col-md-12">
              <div className="row">
                <div className="col-md-6 text-center">
                  <div className="card">
                    <div className="card-body">
                      <h3 className="card-title">Employee Revenue</h3>
