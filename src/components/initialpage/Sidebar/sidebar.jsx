          ...
          role == "user" ? (
            <>
              <ul>
                ...
                >
                  <a href="#">
                    <i class="fa fa-bell-o"></i> <span>Notice Board</span>
                  </a>
                </li>
                ...
                >
                  <Link to="/app/performance/promotion">
                    <i className="la la-sign-out" /> <span>Log Out</span>
                  </Link>
                </li>
              </ul>
            </>
          ...
          role == "admin" ? (
            <>
              <ul>
                ...
                <li className="submenu">
                  <Link to="/app/ui-interface/tables/basic">
